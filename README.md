...
1. Potrebno je prvo skinuti sa Debianovog sajta ISO instalacioni fajl:
    ...
    * ili non-free verziju https://cdimage.debian.org/cdimage/unofficial/non-free/cd-including-firmware/10.7.0+nonfree/amd64/iso-cd/firmware-10.7.0-amd64-netinst.iso
